...
class BYOBAgilityWidgetClasses {
        ...
        function style_form($id, $name, $value) {
                ...
                <p>
                    ...
                    <select id="<?php echo $id; ?>" name="<?php echo $name; ?>" >
                        ...
                        <option value="supplemental"<?php echo $selected = $value == 'supplemental' ? ' selected="selected"' : ''; ?>>Supplemental</option>
                        <option value="supplemental-2"<?php echo $selected = $value == 'supplemental-2' ? ' selected="selected"' : ''; ?>>Supplemental 2</option>
                        <?php
