...
class byob_page_specific_content_widget extends WP_Widget {
        ...
        function form($instance) {
                ...
                <p>
                    <input id="<?php echo $this->get_field_id('show_widget_title'); ?>" type="checkbox" name="<?php echo $this->get_field_name('show_widget_title'); ?>" value="1"<?php checked($instance['show_widget_title']); ?> />
